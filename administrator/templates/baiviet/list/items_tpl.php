<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#xoahet").click(function () {
            ...
            if (hoi == true)
                document.location = "index.php?com=baiviet&act=delete_list&type=<?= $_GET['type'] ?>&curPage=<?= $_GET['curPage'] ?>&listid=" + listid;
        });
    });
</script> 
                ...
                <?php for ($i = 0, $count = count($items); $i < $count; $i++) { ?>
                    <tr>
                        ...
                        <td class="actBtns">
                            ...
                            <a href="index.php?com=baiviet&act=delete_list&id=<?= $items[$i]['id'] ?><?php if ($_REQUEST['type'] != '') echo'&type=' . $_REQUEST['type']; ?>" onClick="if (!confirm('Xác nhận xóa'))
                      return false;" title="" class="smallButton tipS" original-title="Xóa bài viết"><img src="./images/icons/dark/close.png" alt=""></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
