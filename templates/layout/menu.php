...
<nav id="smoothmenu1" class="ddsmoothmenu">
    <ul>
        ...
        <li class="icon <?php if ($_GET['com'] == 'tuong-cay' || $_GET['com'] == 'san-thuong' || $_GET['com'] == 'tieu-canh' || $_GET['com'] == 'galery') { ?>active<?php } ?>">
            <a><?= _duan ?></a>
            <ul class="ddshadow">
                <li class="icon <?php if ($_GET['com'] == 'tuong-cay') { ?>active<?php } ?>"><a href="tuong-cay.html">Tường cây</a></li>
                <li class="icon <?php if ($_GET['com'] == 'san-thuong') { ?>active<?php } ?>"><a href="san-thuong.html">Sân thượng</a></li>
                <li class="icon <?php if ($_GET['com'] == 'tieu-canh') { ?>active<?php } ?>"><a href="tieu-canh.html">Tiểu cảnh</a></li>          
                <li class="icon <?php if ($_GET['com'] == 'gallery') { ?>active<?php } ?>"><a href="gallery.html">Gallery</a></li>
            </ul>
        </li>
        <li class="icon <?php if ($_GET['com'] == 'san-pham') { ?>active<?php } ?>"><a href="san-pham.html"><?= _sanpham ?></a></li>
